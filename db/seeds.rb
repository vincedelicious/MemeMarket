...
meme.photo.attach(io: File.open("app/assets/images/MemeBackvsFront.jpg"), filename: "MemeBackvsFront.jpg", content_type: "image/jpg")
meme.save!
...
meme1.photo.attach(io: File.open("app/assets/images/MemeBigBrainTime.jpg"), filename: "MemeBigBrainTime.jpg", content_type: "image/jpg")
meme1.save!
...
meme2.photo.attach(io: File.open("app/assets/images/MemeDocumentation.jpg"), filename: "MemeDocumentation.jpg", content_type: "image/jpg")
meme2.save!
...
meme3.photo.attach(io: File.open("app/assets/images/MemeSleep.webp"), filename: "MemeSleep.webp", content_type: "image/webp")
meme3.save!
...
meme4.photo.attach(io: File.open("app/assets/images/MemeNo.jpg"), filename: "MemeNo.jpg", content_type: "image/jpg")
meme4.save!
...
meme5.photo.attach(io: File.open("app/assets/images/MemeRGB.jpg"), filename: "MemeRGB.jpg", content_type: "image/jpg")
meme5.save!

meme6 = Meme.new(title: "Junior Developer", description: "Self esteem of junior developer.", category: "LOL", price: "5", user_id: "1")
meme6.photo.attach(io: File.open("app/assets/images/MemeSQL.jpg"), filename: "MemeSQL.jpg", content_type: "image/jpg")
meme6.save!
...
meme7.photo.attach(io: File.open("app/assets/images/MemeStackoverflow.png"), filename: "MemeStackoverflow.png", content_type: "image/png")
meme7.save!
...
meme8.photo.attach(io: File.open("app/assets/images/MemeStranded.jpg"), filename: "MemeStranded.jpg", content_type: "image/jpg")
meme8.save!

meme9 = Meme.new(title: "Sword Bug", description: "Finding a new bug after fixing the last.", category: "LMAO", price: "2500", user_id: "1")
meme9.photo.attach(io: File.open("app/assets/images/MemeSword.png"), filename: "MemeSword.png", content_type: "image/png")
meme9.save!
