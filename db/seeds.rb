...
meme1 = Meme.new(title: "Bell Curve of Knowledge", description: "Related: The Dunning Kruger Effect", category: "Imposter", price:"113", user: user2 )
...
meme3 = Meme.new(title: "Why won't it work?", description: "Possibly related to showerthoughts", category: "FullStack", price:"10", user: user2 )
...
meme7 = Meme.new(title: "Professor C++", description: "WHY DO I OPEN SO MANY TABS", category: "FullStack", price: "1000", user: user2)
...
meme9 = Meme.new(title: "Unsheathe", description: "I'm a professional.", category: "Imposter", price: "2500", user: user2)
